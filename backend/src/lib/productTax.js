/** Countries whose products carry no Indian GST when a local supplier sells them: 0% in Thailand (ADR 023) and the UAE (ADR 024). */
export const GST_FREE_COUNTRIES = Object.freeze(["Thailand", "United Arab Emirates"]);
