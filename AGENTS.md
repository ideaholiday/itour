...
- **Tests**: `cd backend && npm test` (266 unit tests across 9 suites)
- **Integration**: `cd backend && npm run test:integration` (14 real-HTTP journey tests)
...
- **Migrations**: `cd backend && npm run migrate:status` / `migrate:up` (migrations 001–020)
