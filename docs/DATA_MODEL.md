...
- Operator-platform tables (hotel, car and activity rate sheets, quotations, supplier agents, staff, direct-booking payments): [`DATA_MODEL_OPERATOR.md`](DATA_MODEL_OPERATOR.md).
- **`driver_assignments`**:
  - `id`: Primary key.
