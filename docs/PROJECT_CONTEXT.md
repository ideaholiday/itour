...
- **Automated Testing**: 294 backend unit tests across 9 suites and isolated HTTP integration tests passing; Playwright E2E browser tests covering extranet setup, live availability selection, held checkout, payment, and QR voucher generation.
