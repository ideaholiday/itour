...
| D4 | **Europe skipped (owner decision 2026-09-22); not needed until Europe reopens.** **Europe payouts.** PRODUCT non-goal 3 says everything settles in INR. EU suppliers realistically need EUR payouts. | Contradicts a non-goal — owner must lift it or keep INR-only for Europe. |
| D5 | **Europe skipped (owner decision 2026-09-22); not needed until Europe reopens.** Europe compliance: VAT on travel (TOMS), DAC7 platform reporting of sellers, GDPR. | **UNKNOWN — needs legal advice.** Europe should not open until answered. |
