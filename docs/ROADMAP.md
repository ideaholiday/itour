...
- Keep all suites green: 294 unit, 17 integration, 10 e2e.
...
**2. Promotional / last-minute rates**
Discount windows with their own validity rules, distinct from seasonal
schedules. Needs a clear precedence rule against `native_price_schedules`.

**3. Branch coverage on error paths**
...
**4. Real external provider adapter**
