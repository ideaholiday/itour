...
### 3.10 Hotel rate sheet, cars and activities, and package quotations (ADR 040, ADR 042)
Rules: [`SUPPLIER_OPERATIONS.md`](SUPPLIER_OPERATIONS.md). Owner or manager.
