...
| Live driver location (GPS) | `driverTrips.js`, `ops.js`, `suppliers.js` | `driverLocationService` | `pages/DriverTrip.jsx`, `components/ops/LiveTripMapView.jsx`, `components/supplier/SupplierBookingManager.jsx` |
