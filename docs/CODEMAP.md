...
| Staff blog (ADR 026) | `blog.js` (public), `admin.js` (`/admin/blog`), `seo.js` (pages, sitemap) | `blogService`, `shared/blogMarkdown.js`, `shared/blogSeo.js` | `pages/BlogIndex.jsx`, `pages/BlogPost.jsx`, `components/BlogBody.jsx`, `pages/admin/BlogPostsView.jsx` |
