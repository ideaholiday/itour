...
| Package quotations, hotel rate sheet, cars and activities rate sheet, PDF and share link (ADR 040, ADR 042) | `suppliers.js` (`/:id/hotels`, `/:id/cab-types`, `/:id/services`, `/:id/quotations`), `quotations.js` (public `/share/:token`) | `quotationService`, `quotationPdfService` (pdfkit), `supplierHotelService`, `supplierRateSheetService`, `supplierBookingService` (package-line bookings), `emailService` (attachments) | `components/supplier/SupplierQuotationsPanel.jsx` (`?panel=packages`), `components/supplier/SupplierHotelRatesPanel.jsx`, `components/supplier/SupplierRateSheetPanel.jsx` |
