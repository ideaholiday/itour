...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    kyb_status VARCHAR(50) DEFAULT 'PENDING', -- 'PENDING', 'APPROVED', 'REJECTED', 'SUSPENDED'
    is_verified BOOLEAN DEFAULT false,
    commission_rate DECIMAL(5, 2) DEFAULT 15.00, -- 15% platform commission
...
CREATE TABLE IF NOT EXISTS kyb_documents (
    ...
    doc_type VARCHAR(50) NOT NULL, -- 'AADHAAR', 'PAN', 'GSTIN', 'COMMERCIAL_PERMIT', 'COMMERCIAL_TRANSPORT_LICENSE'
...
CREATE TABLE IF NOT EXISTS products (
    ...
    status VARCHAR(50) DEFAULT 'PUBLISHED', -- 'DRAFT', 'PENDING_REVIEW', 'PUBLISHED', 'REJECTED', 'ARCHIVED'
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    booking_status VARCHAR(50) DEFAULT 'CONFIRMED', -- 'CONFIRMED', 'CANCELLED', 'COMPLETED', 'DISPUTED'
    otp_code VARCHAR(6) NOT NULL DEFAULT '4829', -- Pickup verification code
...
-- 12. DRIVER & FLEET ASSIGNMENTS TABLE
