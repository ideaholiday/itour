...
```bash
cd backend && npm test              # 313 unit tests across 9 suites
...
- `.github/workflows/ci.yml`: Runs 313 backend unit tests across 9 suites, 17 HTTP integration tests, coverage gates, Playwright E2E journeys, and builds on PR/push.
...
│   ├── test/                        # 313 Deterministic Backend Unit Tests (9 Suites)
